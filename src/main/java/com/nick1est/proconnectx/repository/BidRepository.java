...
public interface BidRepository extends JpaRepository<Bid, Long> {
    ...
    @Query("SELECT bid FROM Bid bid " +
            ...
            "and (:rating is null or bid.freelancer.rating = :rating) " +
            "and (:firstName is null or bid.freelancer.firstName ILIKE %:firstName%) " +
            "and (:lastName is null or bid.freelancer.lastName ILIKE %:lastName%) " +
