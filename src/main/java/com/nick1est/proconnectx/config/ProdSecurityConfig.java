...
import com.nick1est.proconnectx.auth.ProdAuthTokenFilter;
...
public class ProdSecurityConfig {
    ...
    @Bean
    public ProdAuthTokenFilter authenticationJwtTokenFilter() {
        return new ProdAuthTokenFilter();
    }
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://192.168.178.107:5173", "http://localhost:5173", "http://frontend:5173"));
