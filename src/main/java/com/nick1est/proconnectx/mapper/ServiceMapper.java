...
public abstract class ServiceMapper extends CommonMapper {
    ...
    public abstract ServiceDao serviceCreateDtoToService(ServiceCreateDto serviceCreateDto);

    public abstract List<ServiceFilterResponse> servicesToServiceFilterResponses(List<ServiceDao> services);
}
